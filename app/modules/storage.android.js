...
storage.save = function (folder, fileName) {
    let result;
    const filesDir = application.android.context
    ...
    const input = new java.io.File(
        application.android.context.getDatabasePath(fileName).getAbsolutePath()
    );
    ...
    function process(arg) {
        ...
        try {
            ...
            myOutput = new java.io.FileOutputStream(
                arg + folder + "/" + fileName
            );
...
storage.create = function (folder, fileName, text) {
    ...
    if (storage0.exists()) {
        ...
        const folder = new java.io.File(storage0 + folder);
        ...
        const folder = new java.io.File(storage1 + folder);
        ...
        const folder = new java.io.File(storage2 + folder);
